...
#Run this script, immediately after installing Pop Os, using sudo
...
# Webp support to Image Viewer (ppa:helkaluin/webp-pixbuf-loader is only needed pre 22.04)
